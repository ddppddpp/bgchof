...
*generate_list* - creates a list and sets all dates with a base value of 6
...
*date_number* - helper function, returns the item number within the year for a the input date
...
*fasting_value_to_message* - transforms the integer input (0..6) to a message for CLI output